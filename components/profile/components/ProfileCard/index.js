    ...
    return (
      <div className="flex flex-col w-full relative items-center space-y-3">
        ...
        <div className="flex flex-col w-full jusify-center items-center">
          ...
          <h1 className=" text-sm font-sans text-gray-400">
            {otherUser ? (showPhone ? phone : "") : phone}
          </h1>
        </div>
        {about ? (
        ...
        {accountType === "Business" && (
          <div
            className="flex w-full mt-2 px-2 justify-center "
          ...
          <>
            ...
            <div className="flex w-full justify-between space-x-2">
              <button
                onClick={_Follow}
                className={`${
                  isFollowing ? "followingBtn" : "followBtn"
                }  w-full`}
              >
