...
const Card = ({ video, title, description, onClick, picture,rating,views }) => {
    return (
      <div className="max-w-sm h-auto rounded-lg border card shadow-md">
        ...
        <div className="flex items-center w-full space-x-3 p-3 pb-2">
          ...
          <div className="flex flex-col w-full ">
            <h1 className="text-md text-sm sm:text-md text-bold font-sans">
              {title}
            </h1>
            <h1 className="text-sm text-gray-600 font-sans break-all">
              {description}
            </h1>
          </div>
        </div>
        <div className="flex w-full justify-end p-2">
          <Button
            ...
            childrens={"Remove"}
            classNames={
              "px-3 py-2 w-28 flex justify-center items-center text-white text-sm danger-btn rounded-md"
            }
          />
        </div>
      </div>
